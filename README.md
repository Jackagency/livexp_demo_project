...
>- [x] *Поиск Английского языка во вкладке 'Все языки'*
>- [x] *Поиск Немецкого языка во вкладке 'Все языки'*
>- [x] *Поиск Старорусского языка во вкладке 'Все языки'*
>- [x] *Проверка заголовка во вкладке 'Блог'*
>- [x] *Проверка доступности приложения в Google Play*
>- [x] *Проверка доступности приложения в AppStore*
>- [x] *Проверка заголовка главной страницы*
>- [x] *Проверка наличия ошибок в консоли*

## :computer: Запуск тестов из терминала 

### Локальный запуск тестов с параметрами и без

```bash
gradle clean test //запуск всех тестов

gradle clean Search //запуск тестов связанных с поиском

gradle clean Main //запуск тестов связанных с основными UI проверками
```
